...
cli-key-length = Key length: { $bytes } bytes.
cli-key-fingerprint = Key fingerprint (SHA256): { $fingerprint }.
cli-key-storage = Key backend: { $backend }.
...
cli-key-slot-current = Active key slot: { $slot }.
...
cli-key-slot-list-row = Slot { $slot } ({ $active }): { $state }, label { $label }, fingerprint { $fingerprint }, backend { $backend }, evidence records { $evidence }, last used { $last }
...
cli-status-audiowmark_version_error = Failed to read audiowmark version: { $error }.
...
cli-status-media-eac3 = E-AC-3 decode support: { $available }.
cli-status-media-containers = Supported containers: { $containers }.
...
cli-detect-done = Detect run finished: { $ok } found, { $miss } not found, { $invalid } invalid. Next: inspect invalid files before any decision.
...
cli-decode-version = Watermark version: { $version }.
cli-decode-timestamp_minutes = Watermark timestamp (minutes): { $minutes }.
cli-decode-timestamp_utc = Watermark timestamp (UTC seconds): { $seconds }.
cli-decode-key_slot = Key slot: { $key_slot }.
cli-decode-tag = Tag: { $tag }.
cli-decode-identity = Identity: { $identity }.
cli-decode-status_valid = Verification status: valid.
...
cli-evidence-list-row = Evidence #{ $id } | { $created_at } | { $identity }/{ $tag } | key slot { $slot } | SNR { $snr } | PCM SHA256 { $sha } | { $path }
cli-evidence-field-id = Evidence ID: { $value }
...
cli-evidence-field-version = Watermark version: { $value }
cli-evidence-field-key_slot = Key slot: { $value }
cli-evidence-field-timestamp = Watermark timestamp (minutes): { $value }
cli-evidence-field-message_hex = Watermark message (hex): { $value }
